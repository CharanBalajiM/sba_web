        ...
        <div className="flex items-center justify-between h-20">
                ...
                <div className="py-1">
                  {services.map((svc) => (
                    <Link
                      ...
                      className="block px-4 py-2.5 text-xs text-gray-700 hover:bg-mint hover:text-primary transition-colors"
                    >
                      {svc.name}
                    </Link>
                  ))}
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a
              ...
              className="flex items-center space-x-2 text-xs font-semibold text-primary hover:text-primary-light border border-primary/20 hover:border-primary/50 px-4 py-2 rounded-full transition-all"
            >
            ...
            <a
              ...
              className="flex items-center space-x-2 text-xs font-semibold bg-primary text-white hover:bg-primary-light px-5 py-2.5 rounded-full shadow-sm hover:shadow transition-all"
            >
        ...
        <div className="md:hidden border-t border-gray-100 bg-white shadow-xl absolute top-full left-0 w-full z-40 transition-all duration-300">
          <nav className="flex flex-col p-6 space-y-4">
            ...
            <div className="border-t border-gray-100 pt-4 flex flex-col gap-3">
              <a
                href="tel:+919345632103"
                className="flex items-center justify-center space-x-2 text-sm font-semibold text-primary border border-primary/20 py-3 rounded-xl hover:bg-gray-50 transition-all"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center space-x-2 text-sm font-semibold bg-primary text-white py-3 rounded-xl hover:bg-primary-light shadow-sm transition-all"
              >
